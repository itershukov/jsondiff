...
!function (a) {
    debugger
    if ("object" == typeof exports && "undefined" != typeof module) window.jp = a(); else if ("function" == typeof define && define.amd) define([], a); else {
        var b;
    ...
    return function b(a, c, d) {
        ...
        "./aesprim": [function (b, c, d) {
            !function (b, c) {
                "use strict";
                "function" == typeof a && a.amd ? a(["exports"], c) : c("undefined" != typeof d ? d : b.esprima = {})
            }(this, function (a) {
                "use strict";
                ...
                function h(a) {
                    return 64 == a || 36 === a || 95 === a || a >= 65 && 90 >= a || a >= 97 && 122 >= a || 92 === a || a >= 128 && eb.NonAsciiIdentifierStart.test(String.fromCharCode(a))
                }

                function i(a) {
                    return 36 === a || 95 === a || a >= 65 && 90 >= a || a >= 97 && 122 >= a || a >= 48 && 57 >= a || 92 === a || a >= 128 && eb.NonAsciiIdentifierPart.test(String.fromCharCode(a))
                }
                ...
                function o(a) {
                    ...
                    }; lb > ib;) if (d = gb.charCodeAt(ib), ++ib, g(d)) return pb.comments && (e = gb.slice(b + a, ib - 1), c.end = {
                        line: jb,
                        column: ib - kb - 1
                ...
                function p() {
                    ...
                    }); lb > ib;) if (c = gb.charCodeAt(ib), g(c)) 13 === c && 10 === gb.charCodeAt(ib + 1) && ++ib, ++jb, ++ib, kb = ib, ib >= lb && O({}, db.UnexpectedToken, "ILLEGAL"); else if (42 === c) {
                ...
                function q() {
                    var a, b;
                    for (b = 0 === ib; lb > ib;) if (a = gb.charCodeAt(ib), f(a)) ++ib; else if (g(a)) ++ib, 13 === a && 10 === gb.charCodeAt(ib) && ++ib, ++jb, kb = ib, b = !0; else if (47 === a) if (a = gb.charCodeAt(ib + 1), 47 === a) ++ib, ++ib, o(2), b = !0; else {
                        if (42 !== a) break;
                        ++ib, ++ib, p()
                    } else if (b && 45 === a) {
                ...
                function t() {
                    var a, b;
                    for (a = ib++; lb > ib;) {
                        if (b = gb.charCodeAt(ib), 92 === b) return ib = a, s();
                        if (!i(b)) break;
                        ++ib
                    }
                ...
                function v() {
                    var a, b, c, d, e = ib, f = gb.charCodeAt(ib), g = gb[ib];
                    switch (f) {
                        case 46:
                        case 40:
                        case 41:
                        ...
                        default:
                            if (a = gb.charCodeAt(ib + 1), 61 === a) switch (f) {
                                case 43:
                                case 45:
                                case 47:
                                case 60:
                    ...
                    return d = gb.substr(ib, 4), ">>>=" === d ? (ib += 4, {
                        type: $a.Punctuator,
                        value: d,
                        lineNumber: jb,
                        lineStart: kb,
                ...
                function w(a) {
                    for (var b = ""; lb > ib && d(gb[ib]);) b += gb[ib++];
                ...
                function x(a) {
                    for (var b = "0" + gb[ib++]; lb > ib && e(gb[ib]);) b += gb[ib++];
                ...
                function z() {
                    var a, c, d, f, h, i, j, k, l = "", m = !1;
                    for (j = jb, k = kb, a = gb[ib], b("'" === a || '"' === a, "String literal must starts with a quote"), c = ib, ++ib; lb > ib;) {
                        if (d = gb[ib++], d === a) {
                            a = "";
                            break
                        }
                        if ("\\" === d) if (d = gb[ib++], d && g(d.charCodeAt(0))) ++jb, "\r" === d && "\n" === gb[ib] && ++ib, kb = ib; else switch (d) {
                            case"u":
                            case"x":
                            ...
                            case"v":
                                ...
                                break;
                            default:
                                e(d) ? (f = "01234567".indexOf(d), 0 !== f && (m = !0), lb > ib && e(gb[ib]) && (m = !0, f = 8 * f + "01234567".indexOf(gb[ib++]), "0123".indexOf(d) >= 0 && lb > ib && e(gb[ib]) && (f = 8 * f + "01234567".indexOf(gb[ib++]))), l += String.fromCharCode(f)) : l += d
                        } else {
                ...
                function B() {
                    var a, c, d, e, f;
                    for (a = gb[ib], b("/" === a, "Regular expression literal must start with a slash"), c = gb[ib++], d = !1, e = !1; lb > ib;) if (a = gb[ib++], c += a, "\\" === a) a = gb[ib++], g(a.charCodeAt(0)) && O({}, db.UnterminatedRegExp), c += a; else if (g(a.charCodeAt(0))) O({}, db.UnterminatedRegExp); else if (d) "]" === a && (d = !1); else {
                        if ("/" === a) {
                            e = !0;
                            break
                        }
                    ...
                    return e || O({}, db.UnterminatedRegExp), f = c.substr(1, c.length - 2), {value: f, literal: c}
                }

                function C() {
                    var a, b, c, d;
                    for (b = "", c = ""; lb > ib && (a = gb[ib], i(a.charCodeAt(0)));) if (++ib, "\\" === a && lb > ib) if (a = gb[ib], "u" === a) {
                        if (++ib, d = ib, a = r("u")) for (c += a, b += "\\u"; ib > d; ++d) b += gb[d]; else ib = d, c += "u", b += "\\u";
                        P({}, db.UnexpectedToken, "ILLEGAL")
                    } else b += "\\", P({}, db.UnexpectedToken, "ILLEGAL"); else c += a, b += a;
                ...
                function E() {
                    var a, b, c, d;
                    return q(), a = ib, b = {start: {line: jb, column: ib - kb}}, c = D(), b.end = {
                        line: jb,
                        column: ib - kb
                ...
                function G() {
                    var a, b;
                    if (a = pb.tokens[pb.tokens.length - 1], !a) return E();
                    if ("Punctuator" === a.type) {
                        ...
                        if ("}" === a.value) {
                            if (pb.tokens[pb.openCurlyToken - 3] && "Keyword" === pb.tokens[pb.openCurlyToken - 3].type) {
                                if (b = pb.tokens[pb.openCurlyToken - 4], !b) return v()
                            } else {
                                if (!pb.tokens[pb.openCurlyToken - 4] || "Keyword" !== pb.tokens[pb.openCurlyToken - 4].type) return v();
                                if (b = pb.tokens[pb.openCurlyToken - 5], !b) return E()
                            }
                ...
                function I() {
                    var a, b, c;
                    return q(), a = {start: {line: jb, column: ib - kb}}, b = H(), a.end = {
                        line: jb,
                        column: ib - kb
                ...
                function J() {
                    var a;
                    return a = nb, ib = a.end, jb = a.lineNumber, kb = a.lineStart, nb = "undefined" != typeof pb.tokens ? I() : H(), ib = a.end, jb = a.lineNumber, kb = a.lineStart, a
                }

                function K() {
                    var a, b, c;
                    a = ib, b = jb, c = kb, nb = "undefined" != typeof pb.tokens ? I() : H(), ib = a, jb = b, kb = c
                }
                ...
                function V() {
                    var a;
                    return nb.type !== $a.Punctuator ? !1 : (a = nb.value, "=" === a || "*=" === a || "/=" === a || "%=" === a || "+=" === a || "-=" === a || "<<=" === a || ">>=" === a || ">>>=" === a || "&=" === a || "^=" === a || "|=" === a)
                }

                function W() {
                    var a;
                    return 59 === gb.charCodeAt(ib) || T(";") ? void J() : (a = jb, q(), void(jb === a && (nb.type === $a.EOF || T("}") || Q(nb))))
                }
                ...
                function ca() {
                    ...
                    } else a === $a.BooleanLiteral ? (b = J(), b.value = "true" === b.value, c = mb.createLiteral(b)) : a === $a.NullLiteral ? (b = J(), b.value = null, c = mb.createLiteral(b)) : T("/") || T("/=") ? (c = "undefined" != typeof pb.tokens ? mb.createLiteral(E()) : mb.createLiteral(D()), K()) : Q(J());
                    return mb.markEnd(c, d)
                }

                function da() {
                    var a = [];
                    if (R("("), !T(")")) for (; lb > ib && (a.push(pa()), !T(")"));) R(",");
                    return R(")"), a
                }
                ...
                function na() {
                    ...
                    if (a = nb, i = la(), d = nb, e = ma(d, ob.allowIn), 0 === e) return i;
                ...
                function qa() {
                    var a, b = nb;
                    if (a = pa(), T(",")) {
                        for (a = mb.createSequenceExpression([a]); lb > ib && T(",");) J(), a.expressions.push(pa());
                        mb.markEnd(a, b)
                    }
                    return a
                }
                ...
                function ra() {
                    for (var a, b = []; lb > ib && !T("}") && (a = Ua(), "undefined" != typeof a);) b.push(a);
                    return b
                }
                ...
                function Ja() {
                    var a, b, c, d = [];
                    for (c = nb, U("default") ? (J(), a = null) : (S("case"), a = qa()), R(":"); lb > ib && !(T("}") || U("default") || U("case"));) b = Pa(), d.push(b);
                ...
                function Ka() {
                    ...
                    for (d = ob.inSwitch, ob.inSwitch = !0, e = !1; lb > ib && !T("}");) c = Ja(), null === c.test && (e && O({}, db.MultipleDefaultsInSwitch), e = !0), b.push(c);
                ...
                function Qa() {
                    var a, b, c, d, e, f, g, h, i, j = [];
                    for (i = nb, R("{"); lb > ib && nb.type === $a.StringLiteral && (b = nb, a = Ua(), j.push(a), a.expression.type === bb.Literal);) c = gb.slice(b.start + 1, b.end - 1), "use strict" === c ? (hb = !0, d && P(d, db.StrictOctalLiteral)) : !d && b.octal && (d = b);
                    for (e = ob.labelSet, f = ob.inIteration, g = ob.inSwitch, h = ob.inFunctionBody, ob.labelSet = {}, ob.inIteration = !1, ob.inSwitch = !1, ob.inFunctionBody = !0; lb > ib && !T("}") && (a = Ua(), "undefined" != typeof a);) j.push(a);
                    return R("}"), ob.labelSet = e, ob.inIteration = f, ob.inSwitch = g, ob.inFunctionBody = h, mb.markEnd(mb.createBlockStatement(j), i)
                }

                function Ra(a) {
                    var b, c, d, e, f, g, h = [];
                    if (R("("), !T(")")) for (e = {}; lb > ib && (c = nb, b = ta(), f = "$" + c.value, hb ? (l(c.value) && (d = c, g = db.StrictParamName), Object.prototype.hasOwnProperty.call(e, f) && (d = c, g = db.StrictParamDupe)) : a || (l(c.value) ? (a = c, g = db.StrictParamName) : k(c.value) ? (a = c, g = db.StrictReservedWord) : Object.prototype.hasOwnProperty.call(e, f) && (a = c, g = db.StrictParamDupe)), h.push(b), e[f] = !0, !T(")"));) R(",");
                ...
                function Ua() {
                    ...
                    return nb.type !== $a.EOF ? Pa() : void 0
                }

                function Va() {
                    for (var a, b, c, d, e = []; lb > ib && (b = nb, b.type === $a.StringLiteral) && (a = Ua(), e.push(a), a.expression.type === bb.Literal);) c = gb.slice(b.start + 1, b.end - 1), "use strict" === c ? (hb = !0, d && P(d, db.StrictOctalLiteral)) : !d && b.octal && (d = b);
                    for (; lb > ib && (a = Ua(), "undefined" != typeof a);) e.push(a);
                    return e
                }
                ...
                function Ya(a, b) {
                    ...
                    try {
                        ...
                        Xa(), e = pb.tokens, "undefined" != typeof pb.comments && (e.comments = pb.comments), "undefined" != typeof pb.errors && (e.errors = pb.errors)
                    } catch (g) {
                        throw g
                    } finally {
                        pb = {}
                ...
                function Za(a, b) {
                    ...
                    try {
                        c = Wa(), "undefined" != typeof pb.comments && (c.comments = pb.comments), "undefined" != typeof pb.tokens && (Xa(), c.tokens = pb.tokens), "undefined" != typeof pb.errors && (c.errors = pb.errors)
                    } catch (e) {
                        throw e
                    } finally {
                        pb = {}
                ...
                $a = {
                    ...
                    name: "SyntaxTree", processComment: function (a) {
                        ...
                        var d = "||" === a || "&&" === a ? bb.LogicalExpression : bb.BinaryExpression;
                        ...
                        return {type: bb.TryStatement, block: a, guardedHandlers: b, handlers: c, finalizer: d}
        ...
        1: [function (a, b, c) {
            (function (d) {
                var e = function () {
                    ...
                    var b = {
                        ...
                        performAction: function (a, b, d, e, f, g, h) {
                            ...
                            switch (f) {
                                ...
                                case 16:
                                    ...
                                    break;
                                case 17:
                                    e.ast.set({expression: {type: "numeric_literal", value: parseInt(g[i])}});
                                    break;
                                case 18:
                                    break;
                                case 19:
                                ...
                                case 27:
                                    ...
                                    break;
                                case 28:
                                    this.$ = {expression: {type: "string_literal", value: g[i]}}, e.ast.set(this.$);
                                    break;
                                case 29:
                                    this.$ = {expression: {type: "slice", value: g[i]}}, e.ast.set(this.$);
                                    break;
                                case 30:
                                    this.$ = {expression: {type: "wildcard", value: g[i]}}, e.ast.set(this.$);
                                    break;
                                case 31:
                                    this.$ = {expression: {type: "script_expression", value: g[i]}}, e.ast.set(this.$);
                                    break;
                                case 32:
                                    this.$ = {expression: {type: "filter_expression", value: g[i]}}, e.ast.set(this.$);
                                    break;
                                case 33:
                                    this.$ = g[i];
                                    break;
                        ...
                        table: [{
                            ...
                            24: [2, 24],
                            28: [1, 40]
                        }, {24: [2, 30]}, {24: [2, 31]}, {24: [2, 32]}, {24: [2, 25], 28: [2, 25]}, {
                            24: [2, 27],
                            28: [2, 27]
                        }, {24: [2, 28], 28: [2, 28]}, {24: [2, 29], 28: [2, 29]}, {
                            24: [2, 33],
                            28: [2, 33]
                        }, {24: [2, 34], 28: [2, 34]}, {24: [1, 41]}, {
                            1: [2, 21],
                            12: [2, 21],
                            14: [2, 21],
                            22: [2, 21]
                        ...
                        parse: function (a) {
                            ...
                            var c = this, d = [0], e = [null], f = [], g = this.table, h = "", i = 0, j = 0, k = 0,
                                l = 2, m = 1, n = f.slice.call(arguments, 1);
                            ...
                            for (var q, r, s, t, u, v, w, x, y, z = {}; ;) {
                                if (s = d[d.length - 1], this.defaultActions[s] ? t = this.defaultActions[s] : ((null === q || "undefined" == typeof q) && (q = b()), t = g[s] && g[s][q]), "undefined" == typeof t || !t.length || !t[0]) {
                                    var A = "";
                                    y = [];
                                ...
                                switch (t[0]) {
                                    ...
                                    case 2:
                                        ...
                                        }, p && (z._$.range = [f[f.length - (w || 1)].range[0], f[f.length - 1].range[1]]), u = this.performAction.apply(z, [h, j, i, this.yy, t[1], e, f].concat(n)), "undefined" != typeof u) return u;
                ...
                "undefined" != typeof a && "undefined" != typeof c && (c.parser = e, c.Parser = e.Parser, c.parse = function () {
                ...
                }, "undefined" != typeof b && a.main === b && c.main(d.argv.slice(1)))
            }).call(this, a("_process"))
        }, {_process: 12, fs: 8, path: 11}],
        2: [function (a, b, c) {
            b.exports = {
        ...
        4: [function (a, b, c) {
            function d(b, c, d) {
                var e = a("./index"), f = m.parse(c).body[0].expression, g = j(f, {"@": b.value}),
                    h = d.replace(/\{\{\s*value\s*\}\}/g, g), i = e.nodes(b.value, h);
            ...
            function g(a) {
                return function (b, c, d, g) {
                    var h = b.value, i = b.path, j = [], k = function (b, h) {
                        e(b) ? (b.forEach(function (a, b) {
                            ...
                            j.length >= g || d(a, b[a], c) && j.push({path: h.concat(a), value: b[a]})
            ...
            var m = a("./aesprim"), n = a("./slice"), o = a("static-eval"), p = a("underscore").uniq, q = function () {
            ...
            q.prototype.initialize = function () {
                ...
                var b = [a.operation, a.scope, a.expression.type].join("-"), c = this._fns[b];
                ...
                "member-child-identifier": function (a, b) {
                    var c = a.expression.value, d = b.value;
                    return d instanceof Object && c in d ? [{value: d[c], path: b.path.concat(c)}] : void 0
                    ...
                    if (e(b.value)) {
                        var c = a.expression.value.split(":").map(l), d = b.value.map(function (a, c) {
                    ...
                    return a.expression.value.forEach(function (a) {
                        var d = {operation: "subscript", scope: "child", expression: a.expression}, e = this.resolve(d),
                            f = e(d, b);
                        f && (c = c.concat(f))
                    }, this), k(c)
                }, "subscript-descendant-union": function (b, c, d) {
                    var e = a(".."), f = this, g = [], h = e.nodes(c, "$..*").slice(1);
                    return h.forEach(function (a) {
                        g.length >= d || b.expression.value.forEach(function (b) {
                            var c = {operation: "subscript", scope: "child", expression: b.expression},
                                d = f.resolve(c), e = d(c, a);
                            g = g.concat(e)
                        })
                    }), k(g)
                }, "subscript-child-filter_expression": function (a, b, c) {
                    var d = a.expression.value.slice(2, -1), e = m.parse(d).body[0].expression, f = function (a, b) {
                        return j(e, {"@": b})
                    };
                    ...
                    var c = a.expression.value.slice(1, -1);
                    return d(b, c, "$[{{value}}]")
        ...
        }, {"..": "jsonpath", "./aesprim": "./aesprim", "./index": 5, "./slice": 7, "static-eval": 15, underscore: 8}],
        5: [function (a, b, c) {
            function d(a) {
                return "[object String]" == Object.prototype.toString.call(a)
            }

            var e = a("assert"), f = a("./dict"), g = a("./parser"), h = a("./handlers"), i = function () {
            ...
            i.prototype.initialize = function () {
                ...
                return d.forEach(function (b) {
                    var d = b.path.pop(), e = this.value(a, this.stringify(b.path)), f = b.value = c.call(a, e[d]);
                    e[d] = f
                }, this), d
                ...
                if (e.ok(a instanceof Object, "obj needs to be an object"), e.ok(b, "we need a path"), arguments.length >= 3) {
                    ...
                    var f = d.path.slice(-1).shift(), g = this.parent(a, this.stringify(d.path));
                    g[f] = c
                }
                ...
                return a = this._normalize(a), a.forEach(function (a) {
                    if ("root" != a.expression.type) {
                        var d, e = [a.scope, a.operation].join("-"), f = c[e];
                ...
                if (Array.isArray(a) && "string" == typeof a[0]) {
                    ...
                    return a.forEach(function (a, c) {
                        if ("$" != a || 0 !== c) if ("string" == typeof a && a.match("^" + f.identifier + "$")) b.push({
                            ...
                            b.push({operation: "subscript", scope: "child", expression: {value: a, type: d}})
                        }
                    }), b
                }
        ...
        }, {"./dict": 2, "./handlers": 4, "./parser": 6, assert: 9}],
        6: [function (a, b, c) {
            var d = a("./grammar"), e = a("../generated/parser"), f = function () {
                var a = new e.Parser, b = a.parseError;
        ...
        7: [function (a, b, c) {
            ...
            b.exports = function (a, b, c, e) {
                ...
                if (e = e ? d(e) : 1, b = 0 > b ? f + b : b, c = 0 > c ? f + c : c, b = d(0 === b ? 0 : b ? b : e > 0 ? 0 : f - 1), c = d(0 === c ? 0 : c ? c : e > 0 ? f : -1), b = e > 0 ? Math.max(0, b) : Math.min(f, b), c = e > 0 ? Math.min(c, f) : Math.max(-1, c), e > 0 && b >= c) return [];
                if (0 > e && c >= b) return [];
                for (var g = [], h = b; h != c && !(0 > e && c >= h || e > 0 && h >= c); h += e) g.push(a[h]);
                return g
            }
        }, {}],
        8: [function (a, b, c) {
        ...
        9: [function (a, b, c) {
            ...
            var n = a("util/"), o = Array.prototype.slice, p = Object.prototype.hasOwnProperty, q = b.exports = h;
            q.AssertionError = function (a) {
                ...
                if (Error.captureStackTrace) Error.captureStackTrace(this, b); else {
                    var c = new Error;
                    if (c.stack) {
                        var d = c.stack, e = b.name, h = d.indexOf("\n" + e);
                        if (h >= 0) {
                            var i = d.indexOf("\n", h + 1);
                            d = d.substring(i + 1)
                        }
        ...
        }, {"./support/isBuffer": 13, _process: 12, inherits: 10}],
        15: [function (a, b, c) {
            var d = a("escodegen").generate;
            b.exports = function (a, b) {
                b || (b = {});
                var c = {}, e = function f(a) {
                    if ("Literal" === a.type) return a.value;
                    if ("UnaryExpression" === a.type) {
                        var e = f(a.argument);
                        return "+" === a.operator ? +e : "-" === a.operator ? -e : "~" === a.operator ? ~e : "!" === a.operator ? !e : c
                    }
                    if ("ArrayExpression" === a.type) {
                        for (var g = [], h = 0, i = a.elements.length; i > h; h++) {
                            var j = f(a.elements[h]);
                            if (j === c) return c;
                            g.push(j)
                        }
                        return g
                    ...
                    if ("ObjectExpression" === a.type) {
                        for (var k = {}, h = 0; h < a.properties.length; h++) {
                            var l = a.properties[h], m = null === l.value ? l.value : f(l.value);
                            if (m === c) return c;
                            k[l.key.value || l.key.name] = m
                        }
                        return k
                    }
                    if ("BinaryExpression" === a.type || "LogicalExpression" === a.type) {
                        var i = f(a.left);
                        if (i === c) return c;
                        var n = f(a.right);
                        if (n === c) return c;
                        var o = a.operator;
                        return "==" === o ? i == n : "===" === o ? i === n : "!=" === o ? i != n : "!==" === o ? i !== n : "+" === o ? i + n : "-" === o ? i - n : "*" === o ? i * n : "/" === o ? i / n : "%" === o ? i % n : "<" === o ? n > i : "<=" === o ? n >= i : ">" === o ? i > n : ">=" === o ? i >= n : "|" === o ? i | n : "&" === o ? i & n : "^" === o ? i ^ n : "&&" === o ? i && n : "||" === o ? i || n : c
                    }
                    if ("Identifier" === a.type) return {}.hasOwnProperty.call(b, a.name) ? b[a.name] : c;
                    if ("CallExpression" === a.type) {
                        var p = f(a.callee);
                        if (p === c) return c;
                        var q = a.callee.object ? f(a.callee.object) : c;
                        q === c && (q = null);
                        for (var r = [], h = 0, i = a.arguments.length; i > h; h++) {
                            var j = f(a.arguments[h]);
                            if (j === c) return c;
                            r.push(j)
                        }
                        return p.apply(q, r)
                    ...
                    if ("MemberExpression" === a.type) {
                        var k = f(a.object);
                        if (k === c) return c;
                        if ("Identifier" === a.property.type) return k[a.property.name];
                        var l = f(a.property);
                        return l === c ? c : k[l]
                    }
                    if ("ConditionalExpression" === a.type) {
                        var e = f(a.test);
                        return e === c ? c : f(e ? a.consequent : a.alternate)
                    }
                    return "FunctionExpression" === a.type ? Function("return " + d(a))() : c
                }(a);
                return e === c ? void 0 : e
            }
        }, {escodegen: 8}],
